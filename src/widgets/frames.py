...
from src.widgets.buttons import AppButton
...
class Keypad(ctk.CTkFrame):
    def __init__(self, parent, app, i ,j):
        super().__init__(parent)
        self.app = app
        self.pady=10
        self.create_widgets()
    ...
    def create_widgets(self):  
        ...
        self.num.grid(rows=0, column=0, pady=self.pady, padx=5)
        self.num.grid(rows=0, column=1, pady=self.pady, padx=5)
        self.num.grid(rows=0, column=2, pady=self.pady, padx=5)
        self.num.grid(rows=1, column=0, pady=self.pady, padx=5)
        self.num.grid(rows=1, column=1, pady=self.pady, padx=5)
        self.num.grid(rows=1, column=2, pady=self.pady, padx=5)
        self.num.grid(rows=2, column=0, pady=self.pady, padx=5)
        self.num.grid(rows=2, column=1, pady=self.pady, padx=5)
        self.num.grid(rows=2, column=2, pady=self.pady, padx=5)
        self.num.grid(rows=3, column=0, pady=self.pady, padx=5)
        self.num.grid(rows=3, column=1, pady=self.pady, padx=5)
        self.num.grid(rows=3, column=2, pady=self.pady, padx=5)
        self.num.grid(rows=4, column=1, pady=self.pady, padx=5)

    # Keypad cancel and backspace
    def other_widget(self):
        self.erase = AppButton(self, "<", lambda: self.app.erase())
        self.enter = AppButton(self, "Enter", lambda: self.app.enter())
        self.cancel = AppButton(self, "Cancel", lambda: self.app.cancel())
